...
<Steps>
  ...
  <Step title="Go to the 'Visual' Tab">
    Navigate to the **Visual** tab to see your process categories.
  </Step>
  
  <Step title="Click the 'Workflow' Button">
    Find the category bar (e.g., "Lanning Phase") that this workflow will belong to. Click the **"Workflow 🔗"** button on that category bar.
    
    This opens the workflow template builder for that specific category.
  </Step>
