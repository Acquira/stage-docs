...
<Steps>
  ...
  <Step title="Reference the Form in Instructions">
    ...
    **Example:**
    ...
    > Download and fill out the Budget Request Form (available in the Forms section). Complete all required fields marked with (*). Save the completed form as: YourName_BudgetRequest_YYYY-MM-DD.pdf
  </Step>
