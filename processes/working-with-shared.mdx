...
Shared processes appear in a dedicated section on your dashboard, making it easy to find documentation that's relevant to your work.
...
<Tabs>
  <Tab title="Shared Resources Widget">
    **The dedicated shared resources area on your Dashboard**

    Navigate to your **Dashboard** and find the **"Shared Resources"** widget.

    You'll see processes that others have shared with you, organized by:
    - Recently shared
    - Process name
    - Who shared it
...
<Steps>
  ...
  <Step title="Confirm Removal">
    ...
    The process disappears from your "Shared Resources" section.
  </Step>
</Steps>
